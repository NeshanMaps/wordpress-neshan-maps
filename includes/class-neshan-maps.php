...
class Neshan_Maps {
	...
	public function run() {
		...
		add_shortcode( 'neshan-map', array( $this, 'parse_shortcode_simple' ) );
	}
	...
	public function parse_shortcode_simple( $atts = array(), $content = null, $tag = '' ) {
		...
		$plugin_public->render($id, $map, $content);
	}
